...
//服务地址 过时
int var_cfg_service_addr_timeout;
...
acl::master_int_tbl acl::http_rpc_config::var_conf_int_tab[] = {
	...
	{ "var_cfg_register_service_inter", 1,  &var_cfg_regist_service_inter ,  0, 0 },
	{ "var_cfg_update_service_inter",   3,  &var_cfg_update_service_inter ,  0, 0 },
	{ "var_cfg_service_addr_timeout",   10, &var_cfg_service_addr_timeout ,  0, 0 },
	{ NULL,                             0 , NULL ,                           0, 0 }
};
...
acl::master_str_tbl acl::http_rpc_config::var_conf_str_tab[] = {
	...
	{ "var_cfg_server_addr",     "127.0.0.1:10080",                &var_cfg_server_addr },
